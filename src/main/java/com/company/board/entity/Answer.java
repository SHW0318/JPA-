package com.company.board.entity;
...
public class Answer {
	...
	private LocalDateTime createDate;//답변 등록일
	
	private LocalDateTime modifyDate;//답변 수정일
	...
	@ManyToMany
	//다대다 관계가 되면 answer_liker 이름의 테이블로 자동으로 생성됨
	private Set<SiteMember>liker;
